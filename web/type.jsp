...
<%
	...
	HashMap Values =  typeDetails.getCarTypeDetails(type_id);	
%>
      ...
      <h2>Car Type Entry Form</h2>
        <form action="model/type.jsp" method="post">
          ...
          <div>
            ...
            <input type="text" name="company_name" id="type_name" value="<% out.print(Values.get("type_name")); %>" size="22" style="width:300px;" required>
          </div>
                        
          <div class="block clear"></div>
          <div>
            <input name="submit" type="submit" value="<% out.print(typeLabel); %> CarType">
            &nbsp;
